      ...
      <section className="models-section">
        ...
        <Link
            ...
            style={{
              ...
              alignSelf: "flex-end",
              border: "none",
              fontFamily: "Arial, sans-serif", // Replace with actual font if needed
              fontSize: "1.8rem",
              fontWeight: 500,
              color: "white",
              backgroundColor: "#FF532F", // Replace with actual value of $text-orange
              boxShadow: "0 10px 15px rgba(255, 83, 48, 0.35)",
              cursor: "pointer",
              transition: "all 0.3s",
              textDecoration: "none",
            }}
            onMouseEnter={e => e.currentTarget.style.boxShadow = "0 10px 15px rgba(255, 83, 48, 0.55)"}
            onMouseLeave={e => e.currentTarget.style.boxShadow = "0 10px 15px rgba(255, 83, 48, 0.35)"}
        >
          Register Car &nbsp; <i className="fa-solid fa-circle-check"></i>
        </Link>
